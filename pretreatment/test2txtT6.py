...
def readT4T5(fileT4,fileT5,fileT6):
	...
	for i in range(len(list_result)):
		...
		f3.write(list_result[i].word+' '+list_result[i].pos+' '+list_result[i].keyword+' '+list_result[i].position+' '+list_result[i].chunk)
		f3.write('\n')
	print(len(list_chunk))
	return readT4T5
readT4T5('..\CRF++\\testT4.txt','..\CRF++\\testT5.txt','..\CRF++\\testT6.txt')
